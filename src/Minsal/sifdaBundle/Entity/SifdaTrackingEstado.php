 ...
 * SifdaTrackingEstado
 *
 * @ORM\Table(name="sifda_tracking_estado", indexes={@ORM\Index(name="almacena_fk", columns={"id_estado"}), @ORM\Index(name="registra_etapa_fk", columns={"id_etapa"}), @ORM\Index(name="se_registra_fk", columns={"id_orden_trabajo"})})
 * @ORM\Entity
 */
class SifdaTrackingEstado
{
     ...
     * @var string
     *
     * @ORM\Column(name="prog_actividad", type="string", length=25, nullable=false)
     */
