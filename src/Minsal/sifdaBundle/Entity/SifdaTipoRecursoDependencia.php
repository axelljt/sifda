 ...
 *
 * @ORM\Table(name="sifda_tipo_recurso_dependencia", indexes={@ORM\Index(name="se_compone_fk", columns={"id_tipo_recurso"}), @ORM\Index(name="utiliza_fk", columns={"id_dependencia_establecimiento"})})
 * @ORM\Entity
 */
class SifdaTipoRecursoDependencia
{
    ...
    {
       return $this->id." - ".$this->idTipoRecurso->getNombre();
    }
