 ...
 *
 * @ORM\Table(name="ctl_dependencia_establecimiento", indexes={@ORM\Index(name="idx_id_dep_establecimiento", columns={"id_establecimiento"}), @ORM\Index(name="idx_id_dependencia_est", columns={"id_dependencia"}), @ORM\Index(name="idx_id_dependencia_padre", columns={"id_dependencia_padre"})})
 * @ORM\Entity
 */
