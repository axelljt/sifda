 ...
 *
 * @ORM\Table(name="sifda_retraso_actividad", indexes={@ORM\Index(name="puede_tener_fk", columns={"id_orden_trabajo"})})
 * @ORM\Entity
 */
class SifdaRetrasoActividad
{
     ...
     * @var string
     *
     * @ORM\Column(name="razon_retraso", type="string", length=100, nullable=false)
     */
