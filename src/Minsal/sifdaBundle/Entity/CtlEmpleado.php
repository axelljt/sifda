 ...
 * CtlEmpleado
 *
 * @ORM\Table(name="ctl_empleado", indexes={@ORM\Index(name="idx_depen_estab", columns={"id_dependencia_establecimiento"}), @ORM\Index(name="idx_id_cargo", columns={"id_cargo"})})
 * @ORM\Entity
 */
class CtlEmpleado
{
