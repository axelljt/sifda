 ...
 *
 * @ORM\Table(name="sifda_detalle_solicitud_orden", indexes={@ORM\Index(name="idx_det_orden_trabajo", columns={"id_orden_trabajo"}), @ORM\Index(name="idx_id_det_sol_serv", columns={"id_detalle_solicitud_servicio"})})
 * @ORM\Entity
 */
